...
"}")
    ...
    def set_initial_kasir_data(self):
        kasir_username = sesi.LOGGED_IN_USERNAME
        
        self.loggedInUsername = kasir_username # <-- Simpan sesi, untuk digunakan di display_riwayat
        
        self.comboBox_2.clear()
        self.comboBox_2.addItem(kasir_username)
        self.comboBox_2.setCurrentText(kasir_username)
        self.comboBox_2.setEnabled(False)
