...
# Form implementation generated from reading ui file 'menu_create.ui'
#
...
"}")
        ...
        self.comboBox_2 = QtWidgets.QComboBox(self.frame_makanan)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(20, 27, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_14.addItem(spacerItem8)
        self.comboBox_3 = QtWidgets.QComboBox(self.frame_minuman)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.pushButton_3.clicked.connect(self.goto_menu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Tambah Menu"))
        self.label_8.setText(_translate("MainWindow", "Nama"))
        self.label_9.setText(_translate("MainWindow", "Harga"))
        self.label_10.setText(_translate("MainWindow", "Stok"))
        self.label_11.setText(_translate("MainWindow", "Jenis"))
        self.comboBox.setItemText(0, _translate("MainWindow", "Makanan"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Minuman"))
        self.label_12.setText(_translate("MainWindow", "Makanan"))
        self.comboBox_2.setItemText(0, _translate("MainWindow", "--Pilih jenis makanan--"))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "main menu"))
        self.comboBox_2.setItemText(2, _translate("MainWindow", "dessert"))
        self.label_13.setText(_translate("MainWindow", "Minuman"))
        self.comboBox_3.setItemText(0, _translate("MainWindow", "--pilih jenis penyajian--"))
        self.comboBox_3.setItemText(1, _translate("MainWindow", "panas"))
        self.comboBox_3.setItemText(2, _translate("MainWindow", "dingin"))
