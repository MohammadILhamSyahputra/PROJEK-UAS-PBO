...
# Form implementation generated from reading ui file 'QA_user.ui'
#
...
from user_create import Ui_MainWindow as TambahUser
from user_delete import Ui_MainWindow as HapusUser
from user_edit import Ui_MainWindow as EditUser
from user_lihat import Ui_MainWindow as LihatUser
...
"}")
        ...
        self.gridLayout_2.addWidget(self.btn_show, 4, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.btn_hapus, 4, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.btn_edit, 2, 1, 1, 1)
        ...
        self.btn_add.clicked.connect(self.TambahUser)
        self.btn_hapus.clicked.connect(self.HapusUser)
        self.btn_edit.clicked.connect(self.EditUser)
        self.btn_show.clicked.connect(self.LihatUser)
    ...
    def TambahUser(self):
        ...
        self.childUI = TambahUser()
        self.childUI.setupUi(self.childWindow)

        self.childWindow.show()
        self.MainWindow.hide() 

        self.childWindow.destroyed.connect(self.MainWindow.show)

        
    def HapusUser(self):
        self.childWindow = QtWidgets.QMainWindow()
        self.childUI = HapusUser()
        self.childUI.setupUi(self.childWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Manajemen Data Karyawan"))
