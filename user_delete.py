...
"}")
        ...
        self.lineEdit_8.returnPressed.connect(self.loadUserData)
        self.btn_save_3.clicked.connect(self.DeleteData)
        ...
        self.pushButton_5.clicked.connect(self.goto_user)
    ...
    def DeleteData(self):
        ...
        if username == "":
                QtWidgets.QMessageBox.warning(None, "Error", "ID tidak boleh kosong!")
                return
        ...
        QtWidgets.QMessageBox.information(None, "Success", "User berhasil dihapus.")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_28.setText(_translate("MainWindow", "Hapus User"))
